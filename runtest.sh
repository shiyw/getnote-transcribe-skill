...
uv run python -m py_compile \
  ...
  skills/getnote-local-media/scripts/getnote_common.py \
  skills/getnote-note-original/scripts/getnote_common.py \
  ...
  skills/getnote-local-media/scripts/getnote_refresh_desktop_token.py \
